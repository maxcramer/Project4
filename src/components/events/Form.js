  ...
  return (
    <form className="pad" onSubmit={handleSubmit}>
      <div className="field">
        ...
        <input className="input form" name="eventName"
      ...
      <div className="field">
        ...
        <input className="input form" name="startTime"
      ...
      <div className="field">
        ...
        <input className="input form" name="endTime"
          value={event.endTime || ''}
          placeholder="e.g. 1700"
          onChange={handleChange}
        />
      ...
      <div className="field">
        ...
        <input className="input form" name="eventImage"
      ...
      <div className="field">
        ...
        <input className="input form" name="startLocation"
      ...
      <div className="field">
        ...
        <input className="input form" name="endLocation"
      ...
      <div className="field">
        ...
        <input className="input form" name="organiser"
